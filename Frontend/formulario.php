...
<body class="bg-(--fundo)">
    <div class="w-full flex justify-center">
        <div class="w-[90%] md:w-[800px] bg-white rounded-md px-5 mt-5 p-5 shadow-[0_10px_10px_rgba(0,0,0,0.35)]">
            <form id="enviar" method="post" class="grid grid-cols-2 gap-2 justify-center" enctype="multipart/form-data">
                <div class="flex flex-col relative col-span-2 md:col-start-1 md:col-span-1">
                    ...
                    <input class="form-control border h-[40px] rounded-2xl px-2 pl-[27px]" type="file" id="imagem" name="imagem" accept="image/*" required>
                </div>
                <div class="flex flex-col relative col-span-2 md:col-start-2 ">
                    <i class="fa fa-user absolute bottom-[12px] left-[10px]"></i>
                    <label class="form-label">Nome:</label>
                    <input class="border h-[40px] rounded-2xl pl-[27px]" type="text" id="nome" name="nome" placeholder="Nome"> 
                </div>
                <div class="flex flex-col relative col-span-2 md:col-start-1 md:col-span-1">
                    <i class="fa fa-birthday-cake absolute bottom-[12px] left-[10px]"></i>
                    <label class="form-label">Idade:</label>
                    <input class="border h-[40px] rounded-2xl pl-[35px]" type="number" placeholder="Idade" id="idade" name="idade"> 
                </div>
                <div class="flex flex-col relative col-span-2 md:col-start-2">
                    <i class="fa fa-map-marker absolute bottom-[12px] left-[10px]"></i>
                    <label class="form-label">Endereço:</label>
                    <input class="border h-[40px] rounded-2xl pl-[27px]" type="text" id="endereco" name="endereco" placeholder="Endereço"> 
                </div>
                <div class="col-span-2 flex flex-col relative">
                    ...
                    <textarea class="form-control border h-[75px] rounded-md pl-[27px]" id="biografia" placeholder="Biografia" name="biografia"></textarea>
                </div>
